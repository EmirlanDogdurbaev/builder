...
export default withAxios(() => {
  ...
  if (!loading) {
    ...
    <div>
        <Button  style={{
          margin:"5px",backgroundColor:"green" , fontSize:"20px" , fontWeight:"500", padding:"5px 20px"}}>
          Sign up</Button>
        <Button style={{
          margin:"5px",backgroundColor:"green" , fontSize:"20px" , fontWeight:"500", padding:"5px 20px"}}>Sign in</Button>
        </div>
      </form>
    );
  }
